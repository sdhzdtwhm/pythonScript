...
Description:
    ...
    数据库服务器IP地址:192.168.2.38
    异机备份服务器IP地址:192.168.2.252
    数据库保留份数:10份
    脚本运行服务器:192.168.2.253
    定时任务:0 3 * * * python /mvtech/253_mysql_backup.py
'''
...
if __name__ == "__main__":
    ...
    # 备份的数据库列表
    db_name_list = ['gaxsxk', 'blxx_mobile','blxx_shdx','blxx_telecom','qt_blxx','net_manager','qt_interface','sca_web','jeeplus' ]
